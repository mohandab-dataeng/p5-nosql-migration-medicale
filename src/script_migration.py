...
def main():
    ...
    # 2) Un test qui permet de ne pas cumuler la migration si elle a déjà eu lieu(uniqument dans ce projet)
    if db["patients"].count_documents({}) == 0:
        ...
        # On convertit sinon illisible par mongodb : orient = 'records' transforme chaque lignes en dict (le json)
        ...
        # 8) Test de la migration

        # on affiche un documents pour chaque collection qui a bien migré
